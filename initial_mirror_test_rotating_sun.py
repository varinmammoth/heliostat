...
for i in range(0, 17):
    ...
    test_phi = a * np.pi/8 #7 to 6.67 does not work if theta is pi/90
    test_theta = b * np.pi/4 #sulight angle
    ...
    #print('NORMAL PHI', normal_phi, i)
    #print('NORMAL THETA', normal_theta)
